<template>
  <div class="row">
          ...
          <b-tabs nav-class="mb-3">
            <b-tab :title="$t('generatorPage.tabs.main')" active>
              ...
              <b-input-group class="mb-2">
                <b-form-input
                  :state="entrySrc ? null : false"
                  v-model="entrySrc"
                ></b-form-input>
                <b-input-group-text
                  v-b-popover.hover="
                    $t('generatorPage.settings.entrySrcPopover')
                  "
                  :title="$t('generatorPage.settings.entrySrc')"
                  slot="append"
                >
              ...
              <b-input-group class="mb-2">
                <b-form-input
                  :state="outputDir ? null : false"
                  v-model="outputDir"
                ></b-form-input>
                <b-input-group-text
                  v-b-popover.hover="
                    $t('generatorPage.settings.outputDirPopover')
                  "
                  :title="$t('generatorPage.settings.outputDir')"
                  slot="append"
                >
                  <strong class="text-primary">?</strong>
                </b-input-group-text>
              ...
              <b-input-group class="mb-3">
                <b-form-input
                  :state="bundleName ? null : false"
                  v-model="bundleName"
                ></b-form-input>
                <b-input-group-text
                  v-b-popover.hover="
                    $t('generatorPage.settings.bundleNamePopover')
                  "
                  :title="$t('generatorPage.settings.bundleName')"
                  slot="append"
                >
                  <strong class="text-primary">?</strong>
                </b-input-group-text>
              ...
              <o-checkbox
                v-model="hash"
                :name="$t('generatorPage.settings.hash')"
                :popover="$t('generatorPage.settings.hashPopover')"
              />
              <o-checkbox
                :warning="$t('generatorPage.settings.watchDisabled')"
                :disabled="devServer"
                v-model="watch"
                :name="$t('generatorPage.settings.watch')"
                :popover="$t('generatorPage.settings.watchPopover')"
              />
              <o-checkbox
                v-model="devServer"
                :name="$t('generatorPage.settings.devServer')"
                :popover="$t('generatorPage.settings.devServerPopover')"
              />
              <o-checkbox
                v-model="vendorBundle"
                :name="$t('generatorPage.settings.vendorBundle')"
                :popover="$t('generatorPage.settings.vendorBundlePopover')"
              />
              <o-checkbox
                v-model="cleanDist"
                :name="$t('generatorPage.settings.cleanDist')"
                :popover="$t('generatorPage.settings.cleanDistPopover')"
              />
              <o-checkbox
                v-model="htmlInject"
                :name="$t('generatorPage.settings.htmlInject')"
                :popover="$t('generatorPage.settings.htmlInjectPopover')"
              />
              <div v-show="htmlInject">
                <label
                  >{{ $t("generatorPage.settings.htmlInjectPath") }}:</label
                >
                <b-input-group class="mb-2">
                  <b-form-input
                    :state="htmlInjectPath ? null : false"
                    :disabled="!htmlInject"
                    v-model="htmlInjectPath"
                  ></b-form-input>
                </b-input-group>
              </div>
              <label v-if="false"
                >{{ $t("generatorPage.settings.mode") }}:</label
              >
              <b-input-group v-if="false" class="mb-2">
                ...
                />
                <b-input-group-text
                  v-b-popover.hover="$t('generatorPage.settings.modePopover')"
                  :title="$t('generatorPage.settings.mode')"
                  slot="append"
                >
                  <strong class="text-primary">?</strong>
                </b-input-group-text>
            ...
            <b-tab :title="$t('generatorPage.tabs.css')">
              <o-checkbox
                v-model="css.enable"
                :name="$t('generatorPage.settings.enableCss')"
                :popover="$t('generatorPage.settings.enableCssPopover')"
              />
              <o-checkbox
                :disabled="!css.enable"
                v-model="css.extract"
                :name="$t('generatorPage.settings.enableCssExtract')"
                :popover="$t('generatorPage.settings.enableCssExtractPopover')"
              />
              <o-checkbox
                :disabled="!(css.enable && css.extract)"
                v-model="css.minify"
                :name="$t('generatorPage.settings.enableCssMinify')"
              ...
              <o-checkbox
                :warning="
                  css.enable &&
                    !cssSMAvailable &&
                    $t('generatorPage.settings.enableCssSMWarning')
                "
                :disabled="!(css.enable && cssSMAvailable)"
                v-model="css.sourceMap"
                :name="$t('generatorPage.settings.enableCssSM')"
              ...
              <b-input-group class="mb-2">
                <b-form-select
                  ...
                  :options="[
                    { value: 'none', text: 'none' },
                    { value: 'sass', text: 'sass/scss' },
                    { value: 'less', text: 'less' },
                    { value: 'stylus', text: 'stylus' }
                  ]"
                />
                <b-input-group-text
                  v-b-popover.hover="$t('generatorPage.settings.cssPpPopover')"
                  :title="$t('generatorPage.settings.cssPp')"
                  slot="append"
                >
                  <strong class="text-primary">?</strong>
                </b-input-group-text>
            ...
            <b-tab :title="$t('generatorPage.tabs.js')">
              <o-checkbox
                v-model="sourceMap"
                :name="$t('generatorPage.settings.sourceMap')"
                :popover="$t('generatorPage.settings.sourceMapPopover')"
              />
              <o-checkbox
                :warning="$t('generatorPage.settings.uglifyDisabled')"
                :disabled="mode === 'production'"
                v-model="uglify"
                :name="$t('generatorPage.settings.uglify')"
                :popover="$t('generatorPage.settings.uglifyPopover')"
              />
              <o-checkbox
                v-model="js.transform"
                :name="$t('generatorPage.settings.transform')"
                :popover="$t('generatorPage.settings.transformPopover')"
              />
              <o-checkbox
                v-model="js.jsx"
                :name="$t('generatorPage.settings.jsx')"
                :popover="$t('generatorPage.settings.jsxPopover')"
              />
              <o-checkbox
                v-model="js.ts"
                :name="$t('generatorPage.settings.ts')"
                :popover="$t('generatorPage.settings.tsPopover')"
              />
            </b-tab>
            <b-tab :title="$t('generatorPage.tabs.frameworks')">
              <o-checkbox
                v-model="fm.vue"
                :name="$t('generatorPage.settings.vue')"
                :popover="$t('generatorPage.settings.vuePopover')"
              />
              <o-checkbox
                v-model="js.jsx"
                :name="$t('generatorPage.settings.react')"
                :popover="$t('generatorPage.settings.reactPopover')"
              />
            </b-tab>
          </b-tabs>
        </div>
      ...
      <div class="card">
        <div class="card-header">
          <b-tabs v-model="tabIndex" pills content-class="d-none">
            <b-tab title="webpack.config.js" active> </b-tab>
            <b-tab :disabled="!js.ts" title="tsconfig.json"> </b-tab>
          </b-tabs>
        </div>
        <div class="card-body card-scollable">
          <highlight-code v-show="tabIndex === 0" lang="javascript">{{
            webpackConfig
          }}</highlight-code>
          <highlight-code v-show="tabIndex === 1" lang="json">{{
            tsConfig
          }}</highlight-code>
        </div>
        <div class="card-footer text-center">
          <b-button-group v-show="tabIndex === 0" class="mb-2 px-5">
            <b-button @click="saveFile()" variant="outline-primary">{{
              $t("generatorPage.saveFile")
            }}</b-button>
            <b-button
              v-clipboard="webpackConfig"
              @click="alertCountdown = 2"
              variant="outline-primary"
              >{{ $t("generatorPage.copyFile") }}</b-button
            >
          </b-button-group>
          <b-button-group v-show="tabIndex === 1 && js.ts" class="mb-2 px-5">
            <b-button
              ...
              @click="saveTsConfig()"
              variant="outline-primary"
              >{{ $t("generatorPage.saveTsConfig") }}</b-button
            >
            <b-button
              v-if="js.ts"
              v-clipboard="tsConfig"
              @click="alertCountdown = 2"
              variant="outline-primary"
              >{{ $t("generatorPage.copyTsConfig") }}</b-button
            >
          </b-button-group>
          <b-alert
            fade
            ...
            @dismiss-count-down="countdown => (alertCountdown = countdown)"
            >{{ $t("generatorPage.copied") }}!</b-alert
          >
        </div>
      </div>
    </div>
    <div class="col-md-4 mb-1">
      <div class="card mb-2">
        <div class="card-header">
          {{ $t("generatorPage.instructionHeader") }}
        </div>
        <div class="card-body">
          <ul class="list-group">
            <li class="list-group-item">
              {{ $t("generatorPage.downloadYour") }}
              <strong class="text-primary" @click="saveFile()"
                >webpack.config.js</strong
              >
              {{ $t("generatorPage.andPlaceIt") }}
            </li>
            <li v-if="js.ts" class="list-group-item list-group-item-warning">
              {{ $t("generatorPage.downloadYour") }}
              <strong class="text-primary" @click="saveTsConfig()"
                >tsconfig.json</strong
              >
              {{ $t("generatorPage.andPlaceIt") }}
            </li>
            <li class="list-group-item">
              {{ $t("generatorPage.installDependencies") }}:
              <br />
              <code>
                {{ npmInstall }}
              </code>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <ul class="list-group">
            <li class="list-group-item">
              <a target="_blank" href="https://webpack.js.org/concepts/"
                >{{ $t("generatorPage.links.webpackdocs") }}&nbsp;&#128279;</a
              >
            </li>
            <li class="list-group-item">
              <a
                ...
                >{{ $t("generatorPage.links.esmodules") }}&nbsp;&#128279;</a
              >
            </li>
            <li class="list-group-item">
              <a target="_blank" href="https://docs.npmjs.com"
                >{{ $t("generatorPage.links.npmdocs") }}&nbsp;&#128279;</a
              >
            </li>
          </ul>
        </div>
          ...
          this.uglify ? ".min" : ""
              ...
              this.vendorBundle || this.optimizeCss || this.uglify
                ...
                : ""
						...
						${
              this.resolve.length > 2
                ? `resolve: { extensions: [${this.resolve.join(",")}] },`
                : ""
            }
