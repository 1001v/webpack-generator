				...
				<div class="card-body">
					<b-tabs nav-class="mb-3">
						...
						<b-tab :title="$t('generatorPage.tabs.css')">
							...
							<o-checkbox :warning="css.enable && !cssSMAvailable && $t('generatorPage.settings.enableCssSMWarning')" :disabled="!(css.enable && cssSMAvailable)"
			...
			<div class="card mb-2">
				...
				<div class="card-body">
					<ul class="list-group">
						...
						<li v-if="js.ts" class="list-group-item list-group-item-danger">{{$t('generatorPage.downloadYour')}} <strong
